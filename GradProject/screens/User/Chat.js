...
function Chat({navigation, route}){
    ...
    //fuction to send Notification to Receiver if there is new Message
    async function sendPushNotificationHandler(ReceiverNotificationID){
    ...
    const onSend = useCallback((messages = [])=>{
        ...
        sendPushNotificationHandler(displayedChat.receiverInfo[0].data.NotificationsAddress)
