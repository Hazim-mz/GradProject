...
function HallView({ id, name, description, price, weekendPrice, guests, imageUrl, services, menCoun, womanCoun, manDin, womanDin, menBath, womanBath, report, rate, locationOfHall, locationOfUser, isBlocked, ownerID, ownerEmail, cancelAvailable, date, booking, deleateReservations }) {
